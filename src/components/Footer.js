                ...
                < Row className="align-items-center">
                    ...
                    <Col sm={6} className="text-center text-sm-end">
                        <div className="social-icon">
                            <a href="https://www.linkedin.com/in/arthurcavalcanteprofile/"> <img src={navIcon1} /> </a>
                            <a href="https://www.facebook.com/arthurgustavofreirescavalcante/"> <img src={navIcon2} /> </a>
                            <a href="https://www.instagram.com/oarthurcavalcante/"> <img src={navIcon3} /> </a>
                        </div>
